...
/** Formata data para exibição em pt-BR — aceita undefined para compatibilidade com campos opcionais */
...
/** Formata data com hora — aceita undefined para compatibilidade com campos opcionais */
